                   ...
                   <?php foreach ($tbl_kategori_donasi as $d) : ?>
                       <tr>
                           ...
                           <td class="text-center">
                               <a class="btn btn-xs btn-primary" href="<?= base_url() ?>admin/edit_tujuan/<?= $d['id_kategori_donasi'] ?>"><i class="far fa-edit"></i></a>
                               <a class="btn btn-xs btn-danger" href="<?= base_url() ?>admin/delete_tujuan/<?= $d['id_kategori_donasi'] ?>" onclick="return confirm('Anda ingin menghapus ?')"><i class="far fa-trash-alt"></i></a>
                           </td>
                       </tr>
                   <?php endforeach; ?>
               </tbody>
